...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      ...
      url: "https://speedy-nodes-nyc.moralis.io/83fe2dc49820be3f0d48133d/eth/rinkeby", // <---- YOUR MORALIS ID! (not limited to infura)
    ...
    polytest: {
      url: "https://speedy-nodes-nyc.moralis.io/83fe2dc49820be3f0d48133d/polygon/mumbai", // <---- YOUR MORALIS ID! (not limited to infura)
      gasPrice: 1000000000,
      accounts: {
        mnemonic: mnemonic(),
      },
