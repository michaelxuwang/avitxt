<template>
    <v-row class="text-left" justify="center">
        ...
        <v-row>
          <v-col class="col-9">
            <h1 class="display-1 font-weight-bold mb-3">
              <v-icon x-large>mdi-account-box</v-icon> {{address}}
            </h1>
          </v-col>
        </v-row>
      </v-col>
      ...
      >
        ...
        <p>
          # of Competitions Judged: {{ parseInt(Math.random()*20) }}
        </p>
        <p>
          # of Submissions Judged: {{ 30 + parseInt(Math.random()*20) }}
        </p>
        <p>
        ...
        <h3>Judging Patterns and Trends</h3>
        <p>
            <v-sparkline
                :value="value"
                :gradient="gradient"
